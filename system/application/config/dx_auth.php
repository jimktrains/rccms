...
$config['DX_email_account_details'] = FALSE;#TRUE; 
...
$config['DX_recaptcha_public_key'] = '6LflUgQAAAAAAAEYt7A9OnSzM3GIT1K0K9PHxyoA'; 
$config['DX_recaptcha_private_key'] = '6LflUgQAAAAAAGqQhBos4vg9nkBQUq_8LSUZWc7G';
