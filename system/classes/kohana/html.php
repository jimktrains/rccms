...
class Kohana_HTML {
	...
	/**
	 * Creates a http-equiv meta tag
	 *
	 * @param   string  header
	 * @param   string	value
	 * @return  string
	 */
	public static function http_equiv($header, $value){
		$attributes = array();
		$attributes['http-equiv'] = $header;
	 ...
	 * @return  string
	 */
	public static function link($rel, $href, $type = '', $title = ''){
		$attributes = array();
		$attributes['rel'] = $rel;
